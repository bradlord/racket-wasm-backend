...
;; gauge%/slider%/radio-box%/list-box%/group-panel%/tab-panel%), drawn menus
;; (menu.rkt: menu-bar%/menu%/menu-item%) and a modal dialog% (dialog.rkt). Only
;; the printer dc remains a load-bearing stub (stubs.rkt). Selected via
